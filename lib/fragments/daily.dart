...
class DailyFrag extends StatefulWidget {
  @override
  _DailyFragState createState() => _DailyFragState();
}

class _DailyFragState extends State<DailyFrag> {
  List todos = List();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: FutureBuilder(
        future: DBProvider.db.getTodosDaily(),
